...
import * as bootstrap from "bootstrap"; // Đặt ở đầu file
    ...
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-white shadow-sm px-3">
        <div className="container-fluid">
          ...
          {/* Nút ba gạch (offcanvas) bên phải */}
          <button
          ...
          <div className="collapse navbar-collapse d-none d-lg-flex" id="navbarCollapse">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-3">
              <li className="nav-item">
                <Link to="/books" className="nav-link">Kho Sách</Link >
              </li>
              <li className="nav-item">
            ...
            <div className="dropdown">
              <button className="btn btn-outline-secondary dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                ...
                <span>{auth.isLoggedIn ? userInfo.name : "Khách"}</span>
              </button>
          ...
          >
            <div className="offcanvas-header">
              <Link to="/" onClick={handleCloseMenu} className="offcanvas-title fw-bold text-decoration-none text-dark" id="offcanvasMenuLabel">Thư Viện Số</Link>
                ...
                <div className="d-flex align-items-center mb-4 p-2 rounded shadow-sm bg-light">
                  ...
                  <div>
                    ...
                    <div className="text-muted small">
                      {auth.role === "admin" ? "Quản trị viên" : "Thành viên"}
                    </div>
                  </div>
                </div>
              )}
              ...
              <ul className="list-unstyled fs-5">
                ...
                {!auth.isLoggedIn ? (
                  ...
                  <>
                    ...
                    {auth.role === "admin" && (
                      <li className="mb-3">
                        <Link className="text-decoration-none text-dark" to="/library-management" onClick={handleCloseMenu}>
                          🛠️ Quản lý
                        </Link>
                      </li>
                    )}
